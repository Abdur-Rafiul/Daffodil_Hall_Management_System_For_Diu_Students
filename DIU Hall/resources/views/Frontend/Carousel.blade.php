        ...
        <div class="col-lg-3 col-md-12 col-sm-12">
            <div class="card rounded-0" style="border: 2px solid green">
                <div class="bg-image hover-overlay rounded-0" data-mdb-ripple-color="info">
                    <img style="width:100%;height:330px; padding: 10px" src="{{ asset('Frontend\images\sabur.png') }}"
                        class="rounded-0" />
                    <a href="#!">
            ...
            <div id="carouselExampleControls" class="carousel slide" data-mdb-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img style="width:100%;height:500px" src="{{ asset('Frontend\images\diu 1.png') }}"
                            class="d-block w-100" alt="Wild Landscape" />
                    </div>
                    <div class="carousel-item">
                        <img style="width:100%;height:500px" src="{{ asset('Frontend\images\diu 2.jpg') }}"
