                    ...
                    if (response.status == 200) {
                        ...
                        $.each(dataJSON, function(i, item) {
                            $('<div class="col-lg-4 col-md-8 col-sm-12"/>').html(
                                "<div class='card'>" +
                                "<img style='height:320px' data-id=" + dataJSON[i].id + "   src=" +
                                dataJSON[i].floor_img + " class='card-img-top img-fluid rounded-0' />" +
                                "<span><a href='/unit/" + dataJSON[i].floor_name + "'   data-id=" +
                                dataJSON[i].id + " data-name=" + dataJSON[i].floor_name +
                                "   class='floorID btn btn-primary btn-block'> <h3  class='card-title text-center'>" +
                                dataJSON[i].floor_name + "</h3></a></span>"
