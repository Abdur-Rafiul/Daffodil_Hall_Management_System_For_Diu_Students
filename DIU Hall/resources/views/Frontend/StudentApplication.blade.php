                ...
                <div class="row">
                    ...
                    <div class="col-md-8  bg-light p-5">
                        ...
                        <form class="needs-validation" >
                            ...
                            <input required class="w-100 p-3" type="text" id="stdId" name="stdId" placeholder="Enter Your Student ID">

                            <label for="stdName">Name</label>
                            <input class="w-100 p-3" type="text" id="stdName" name="stdName" placeholder="Enter Your Full Name">
                            <label for="stdImg">Photo</label>
                            <input  class='form-control fileInput' type='file' id='formFile' name="fileInput">
                            <label for="FName">Father Name</label>
                            <input class="w-100 p-3" type="text" id="FName" name="FName" placeholder="Enter Your Father Name">
                            <label class="w-100 p-3" for="FContact">Father Contact</label>
                            <input class="w-100 p-3" type="text" id="FContact" name="FContact" placeholder="Enter Your Father Contact">
                            <label for="MName">Mother Name</label>
                            <input class="w-100 p-3" type="text" id="MName" name="MName" placeholder="Enter Your Mother Name">
                            <label for="MContact">Mother Contact</label>
                            <input class="w-100 p-3" type="text" id="MContact" name="MContact" placeholder="Enter Your Mother Contact">
                            ...
                            <input class="w-100 p-3" type="text" id="stdPhone" name="stdPhone" placeholder="Enter Your Phone Number">
                            <label for="stdEmail">Student Email</label>
                            <input class="w-100 p-3" type="text" id="stdEmail" name="stdEmail" placeholder="Enter Your Email">
                            <label for="stdUniversity">Student University</label>
                            <input class="w-100 p-3" type="text" id="stdUniversity" name="stdUniversity" placeholder="Your University Name">
                            <label for="stdDob">Student DOB </label>
                            <input class="w-100 p-3" type="date" id="stdDob" name="stdDob" placeholder="dd-mm-yyyy" value=""
                            ...
                            <input style="font-size: 30px" class="btn btn-primary mt-3" id="submitfromAdmin1" type="submit" value="Submit">
                        </form>
                    </div>
                    <div class="col-md-2"></div>
                </div>
