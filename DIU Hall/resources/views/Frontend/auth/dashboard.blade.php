                ...
                <li class="nav-item" style="list-style-type: none;">
                    ...
                    <div class="dropdown">
                        <a class="dropdown-toggle d-flex align-items-center hidden-arrow me-3" href="#"
                            ...
                            <img class="mb-sm-2 mb-md-2 " loading="lazy"
                                style="width: 50px; height: 50px; border: 2px solid #f3066e;border-radius: 50%"
                                src="{{ $student_img }}" />

                        </a>


                        <ul class="dropdown-menu dropdown-menu-end mt-2" aria-labelledby="navbarDropdownMenuAvatar"
                            style="width: 300px;">
                            <h5 class="card-title text-black text-muted m-4">Signed in as {{ $StudentID2->student_name }}
                            </h5>
                            ...
                            <li class="dropdown-item1">
                                <a class="dropdown-item"
                                    href="/changePassword/{{ $StudentID2->student_id }}/{{ $imgPath }}">Change
                                    Password</a>
                            </li>
                            <li class="dropdown-item1">
