<div class="container bg-light p-5 mb-4" style="border:2px dotted green;">
    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <input class="w-100 p-3 mb-2" id="studentid" type="text" style="border:2px solid green;"
        ...
        <div class="col-md-8">
            ...
            <div class="row">
                ...
                <div class="col-md-4"><i class="fa-solid fa-2x fa-cart-shopping"></i>
                    <button style="border:2px solid red; font-size:20px;"
                        class="ms-3 btn btnPayment text-primary"><a>Payment</a></button>
                </div>
                <div class="col-md-4"></div>
            </div>
        </div>
