    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6 order-md-1 me-5">
                <h4 class="mb-3">DIU Hall Payment Method</h4>
                        ...
                        @foreach ($student as $student)
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="customer_mobile" class="form-control mt-2"
                                        id="customer_mobile" placeholder="Enter Your Full Name"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="customer_address" class="form-control" id="customer_address"
                                    placeholder="Enter Your Full Name" value="{{ $student['student_permanentAddress'] }}"
                                    required>
